...
export default function CartPage() {
  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_360px]">
          <div className="rounded-2xl border border-gray-100 bg-white px-5 sm:px-6">
            <CartItem product={products[0]} onRemove={() => setRemove(true)} />
            <CartItem product={products[2]} onRemove={() => setRemove(true)} />
            <CartItem product={products[1]} onRemove={() => setRemove(true)} />
          </div>
          <div>
            <div className="mb-4">
      ...
      <Modal open={remove} onOpenChange={setRemove} title="Remove item?">
